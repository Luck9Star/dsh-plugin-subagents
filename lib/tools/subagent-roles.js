...
export function registerSubagentRoles(ctx, deps) {
  ...
  ctx.tools.register(defineTool({
    name: 'subagent_roles',
    description: 'List the declarative subagent roles: id, description, pinned backend ("native", a bridge provider name such as codex / claude-code, or caller chooses), the remote product permission mode (readonly/default/full) and whether the role may delegate to its own subagents. Use a role with subagent.',
    parameters: {},
    output: {
